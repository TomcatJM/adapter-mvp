...
- 已复核 `delivery/docs/主流程落地方案.md`、`delivery/docs/云效开放接口调研方案.md`、`delivery/docs/云效工作项创建任务.md`。
...
- 已更新 `delivery/docs/云效工作项创建任务.md`、`delivery/docs/主流程落地方案.md`、`delivery/docs/接口文档.md`、`delivery/docs/当前进度说明.md`、`delivery/docs/云效开放接口调研方案.md`。
...
- 已扩展 `app/db.py` 和 `delivery/sql/mysql_schema.sql`：项目配置表新增 `done_status_id`、`done_status_field_id`、`done_status_names`、`comment_field_key`、`comment_format_type`、`close_transition_id`，并新增 `update_workflow_yunxiao_task_closed` / `mark_workflow_needs_human`。
...
- 已更新 `delivery/docs/接口文档.md`、`delivery/docs/当前进度说明.md`、`delivery/docs/后续配置清单.md`、`delivery/docs/云效工作项关闭和回写任务.md`。
...
- 已补 `app/apifox.py`、`app/db.py`、`scripts/upsert_apifox_project_config.py`、`delivery/sql/mysql_schema.sql`、README 和后续配置清单；待测试、提交、部署和远端 DB 写入真实 OpenAPI URL。
