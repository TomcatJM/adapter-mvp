...
This covers explicit project resolution through globalParams without calling
Apifox.
"""
...
def main() -> None:
    ...
    try:
        ...
        assert result["projectNameSource"] == "payload", result
        ...
        print("apifox resolution smoke OK: PROJECT_NAME=jdb-order -> 7049238")
    finally:
        os.environ.clear()
